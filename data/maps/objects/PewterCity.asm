...
PewterCity_Object:
	...
	warp_event 14, 15, PEWTER_GYM, 1
	warp_event 27, 11, PEWTER_NIDORAN_HOUSE, 1
	warp_event 23, 19, PEWTER_MART, 1
	warp_event  7, 29, PEWTER_SPEECH_HOUSE, 1
	warp_event 13, 25, PEWTER_POKECENTER, 1

	def_bg_events
	bg_event 17, 29, TEXT_PEWTERCITY_TRAINER_TIPS
	bg_event 33, 23, TEXT_PEWTERCITY_POLICE_NOTICE_SIGN
	bg_event 24, 19, TEXT_PEWTERCITY_MART_SIGN
	bg_event 14, 25, TEXT_PEWTERCITY_POKECENTER_SIGN
	bg_event 17,  9, TEXT_PEWTERCITY_MUSEUM_SIGN
	bg_event  7, 17, TEXT_PEWTERCITY_GYM_SIGN
	bg_event 25, 23, TEXT_PEWTERCITY_SIGN

	def_object_events
	object_event  5, 15, SPRITE_COOLTRAINER_F, STAY, NONE, TEXT_PEWTERCITY_COOLTRAINER_F
	object_event 17, 25, SPRITE_COOLTRAINER_M, STAY, NONE, TEXT_PEWTERCITY_COOLTRAINER_M
	object_event 19, 19, SPRITE_SUPER_NERD, STAY, NONE, TEXT_PEWTERCITY_SUPER_NERD1
