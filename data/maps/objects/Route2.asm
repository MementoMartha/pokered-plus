...
Route2_Object:
	...
	warp_event  3,  9, VIRIDIAN_FOREST_NORTH_GATE, 2
	...
	def_bg_events
	bg_event  7, 60, TEXT_ROUTE2_SIGN
	bg_event 11, 11, TEXT_ROUTE2_DIGLETTS_CAVE_SIGN

	def_object_events
	object_event 15, 62, SPRITE_POKE_BALL, STAY, NONE, TEXT_ROUTE2_MOON_STONE, MOON_STONE
