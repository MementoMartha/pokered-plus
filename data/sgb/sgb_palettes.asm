...
; entries correspond to PAL_* constants
	...
	RGB 31,31,31, 31,31,00, 07,07,25, 00,00,17 ; PAL_LOGO1
	RGB 31,31,31, 31,31,00, 07,07,25, 00,00,17 ; PAL_LOGO2
	RGB 31,31,31, 29,16,30, 09,03,27, 01,01,01 ; PAL_0F (used for Mt Moon Crater)
	...
	RGB 31,31,31, 16,18,31, 01,22,06, 03,03,03 ; PAL_BADGE
